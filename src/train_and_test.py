...
def function(w, x, t, r): 
  global last_func
  last_func = objective(x,t,w) + log_prior(w, r)
  return last_func
...
def experiment(cmdline_args):
  ...
  print("tanh-ing everything")
  x = (np.vectorize(math.tanh))(x)
  xdev = (np.vectorize(math.tanh))(xdev)
  xtest = (np.vectorize(math.tanh))(xtest)
  ...
  print '\nFinal training cross entropy', objective(x, t, w)
